...
DATASET_RFT_SPLIT = os.getenv("DATASET_RFT_SPLIT", "default")
...
SAMPLE_TEMPERATURE = float(os.getenv("SAMPLE_TEMPERATURE", 0.6))
SAMPLE_TOP_P = float(os.getenv("SAMPLE_TOP_P", 0.95))
SAMPLE_TOP_K = int(os.getenv("SAMPLE_TOP_K", 20))
